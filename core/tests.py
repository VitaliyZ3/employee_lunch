...
class RestaurantModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.restaurant = Restaurant.objects.create(name='Test Restaurant', food_type=food_type)
...
class MenuViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.dish = Dish.objects.create(name='Test Dish', description='Some description')
        self.menu = Menu.objects.create()
        self.menu.dishes.add(self.dish)

    def test_retrieve_menu(self):
        response = self.client.get(reverse('menu_retrieve_update_destroy', args=[self.menu.id]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_delete_menu(self):
        response = self.client.delete(reverse('menu_retrieve_update_destroy', args=[self.menu.id]))
...
class RestaurantCreateSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.valid_data = {'name': 'Test Restaurant', 'food_type': 1, 'location': "Kyiv"}
